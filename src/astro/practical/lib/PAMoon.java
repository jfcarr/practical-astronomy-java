...
public class PAMoon {
    ...
    public ApproximatePositionOfMoon approximatePositionOfMoon(double lctHour, double lctMin, double lctSec,
        ...
        double sunLongDeg = PAMacros.sunLong(lctHour, lctMin, lctSec, daylightSaving, zoneCorrectionHours, localDateDay,
                localDateMonth, localDateYear);
        double sunMeanAnomalyRad = PAMacros.sunMeanAnomaly(lctHour, lctMin, lctSec, daylightSaving, zoneCorrectionHours,
        ...
        double moonLatDeg = PAMacros
                .wToDegrees(Math.asin(Math.sin(Math.toRadians(lddDeg - ndDeg)) * Math.sin(Math.toRadians(i))));
        ...
        return new ApproximatePositionOfMoon(moonRAHour, moonRAMin, moonRASec, moonDecDeg, moonDecMin, moonDecSec);
    }
}
